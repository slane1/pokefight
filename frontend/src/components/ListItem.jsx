...
const selectPokemon = (item) =>{
    ...
    setFighter([{id: id, name: name.english, type: type[0], hp: base.HP, attack: base.Attack, defense: base.Defense, speed: base.Speed}])
} 


    return (
        <div key={item.id} className="itemcard rounded-md bgBorder-gradient border-gradient">
            <div className="imgcontainer bgBorder-gradient border border-solid p-4 Imageborder-gradient rounded-md bg-white bg-opacity-50">
                ...
                <p className="text-sm text-gold font-bold font-mono">PokeID {item.id}</p>
            </div>
            ...
            <h4 className="text-black text-center font-bold text-sm font-mono p-2">{item.name.english}</h4>
            <h4 className="text-black text-left text-xs font-mono">Attack {item.base.Attack}</h4>
            <h4 className="text-black text-left text-xs font-mono">Defense {item.base.Defense} </h4>
            <h4 className="text-black text-left text-xs font-mono">Speed {item.base.Speed} </h4>
            <h4 className="text-black text-left text-xs font-mono">Sp. Defense {item.base["Sp. Defense"]}</h4>
            <h4 className="text-black text-left text-xs font-mono">Sp. Attack {item.base["Sp. Attack"]}</h4>
